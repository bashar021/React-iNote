...
export default function Form(props) {
    ...
    return (
        <div className='body_container' style={{backgroundImage:`url(${notebook_image})`}}>
            <div id='login_spinner' className="text-center login_spinner">
            ...
            <div className='form_container'>
                <p className='h3 app_title'>yNotebook</p>
                ...
                <div className={`login_form_container  ${signup_form === 'false'?'vissible':'hide'}`}>
                    <form onSubmit={function(e){e.preventDefault();onclick()}}>
                        <div className="mb-3">
                            <label htmlFor="exampleInputEmail1" className="form-label">Email address</label>
                            <input onChange={function(event){update_useremail(event.target.value)}} type="email" className="form-control form_input" id="exampleInputEmail1" aria-describedby="emailHelp"/>
                                <div id="emailHelp" className="form-text">We'll never share your email with anyone else.</div>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="exampleInputPassword1" className="form-label">Password</label>
                            <input onChange={function(event){updateuserpassword(event.target.value)}} type="password" className="form-control form_input" id="exampleInputPassword1"/>
                        </div>
                ...
                <div className={`signup_form_container ${signup_form === 'true'?'vissible':'hide'}`} >
                    <form onSubmit={function(e){e.preventDefault();signup()}}>
                        <div className="mb-3">
                            <label htmlFor="exampleInputPassword1" className="form-label">Name</label>
                            <input onChange={function(event){updateusername(event.target.value)}} type="text" className="form-control form_input"  required/>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="exampleInputEmail1" className="form-label">Email address</label>
                            <input onChange={function(event){update_useremail(event.target.value)}} type="email" className="form-control form_input"  aria-describedby="emailHelp" required/>
                                <div id="emailHelp" className="form-text">We'll never share your email with anyone else.</div>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="exampleInputPassword1" className="form-label">Phone</label>
                            <input onChange={function(event){update_usernumber(event.target.value)}} type="number" className="form-control form_input" required/>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="exampleInputPassword1" className="form-label">Password</label>
                            <input onChange={function(event){updateuserpassword(event.target.value)}} type="password" className="form-control form_input"  required/>
                        </div>
                        <div className="mb-3 form-check">
                                <input type="checkbox" onChange={function(event){event.target.checked?updateremember_me(true):updateremember_me(false)}} className="form-check-input" id="exampleCheck2"/>
                                <label className="form-check-label" style={{color:'white'}} htmlFor="exampleCheck2">Remeber me</label>
                        </div>
                        <button  type="submit" className="btn btn-primary">Submit</button>
                    </form>
